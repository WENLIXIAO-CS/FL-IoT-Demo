...
#     ssh -o StrictHostKeyChecking=no -l ${USERNAME} ${HOSTNAME} "cd /home/nano/fed-iot-demo-lightly/Fed-IoT-demo-lightly; python FL_ClientMain.py -ip 192.168.43.156 > log.txt &"
#     echo ${HOSTNAME}
#     sleep 2
# done
...
# run pi
USERNAME="pi"
HOSTS="192.168.43.28 192.168.43.29 192.168.43.30"
...
for HOSTNAME in ${HOSTS} ; do
    ...
    cd /home/pi/fed-iot-demo-lightly/Fed-IoT-demo-lightly
    python FL_ClientMain.py -ip 192.168.43.156 > log.txt &"
    echo ${HOSTNAME}
    sleep 2
done